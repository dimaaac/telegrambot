...
def respond(update):
    ...
    if text.endswith("@BlisniashkaBot"):
        text = text[:-len("@BlisniashkaBot")]
...
START_MESSAGE = "Hello, Im Dima's @BlisniashkaBot. Try writing \"/help\"."
...
_opts_txt = [
    ...
    ("(what is|whats) your name", "I am nameless."),
